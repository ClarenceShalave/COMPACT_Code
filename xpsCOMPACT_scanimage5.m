function varargout = xpsCOMPACT_scanimage5(varargin)
% XPSCOMPACT_SCANIMAGE5 MATLAB code for xpsCOMPACT_scanimage5.fig
%      XPSCOMPACT_SCANIMAGE5, by itself, creates a new XPSCOMPACT_SCANIMAGE5 or raises the existing
%      singleton*.
%
%      H = XPSCOMPACT_SCANIMAGE5 returns the handle to a new XPSCOMPACT_SCANIMAGE5 or the handle to
%      the existing singleton*.
%
%      XPSCOMPACT_SCANIMAGE5('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in XPSCOMPACT_SCANIMAGE5.M with the given input arguments.
%
%      XPSCOMPACT_SCANIMAGE5('Property','Value',...) creates a new XPSCOMPACT_SCANIMAGE5 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before xpsCOMPACT_scanimage5_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to xpsCOMPACT_scanimage5_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help xpsCOMPACT_scanimage5

% Last Modified by GUIDE v2.5 20-Aug-2020 14:52:14

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @xpsCOMPACT_scanimage5_OpeningFcn, ...
    'gui_OutputFcn',  @xpsCOMPACT_scanimage5_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before xpsCOMPACT_scanimage5 is made visible.
function xpsCOMPACT_scanimage5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to xpsCOMPACT_scanimage5 (see VARARGIN)

% Choose default command line output for xpsCOMPACT_scanimage5
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes xpsCOMPACT_scanimage5 wait for user response (see UIRESUME)
...
function varargout = xpsCOMPACT_scanimage5_OutputFcn(hObject, eventdata, handles)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global coefficients_path probe_number slmphase voltagearray f_defocusscale f_zoom pico_D pico_id_position_matrix pico_positions offset_x offset_y Maberration
...
if wd>=wd_limit1 &&  wd<=wd_limit2
    ...
    zoom_ini=str2double(get(handles.zoom_ini,'String'));
...
global rot_angle
global hSI
startangle=str2double(get(handles.startangle,'String'));
...
if rot_angle>=rot_limit1 &&  rot_angle<=rot_limit2
    ...
    scanimage_angle=startangle-rot_angle;
...
function zoom_ini_Callback(hObject, eventdata, handles)
% hObject    handle to zoom_ini (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of zoom_ini as text
%        str2double(get(hObject,'String')) returns contents of zoom_ini as a double


% --- Executes during object creation, after setting all properties.
function zoom_ini_CreateFcn(hObject, eventdata, handles)
% hObject    handle to zoom_ini (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
