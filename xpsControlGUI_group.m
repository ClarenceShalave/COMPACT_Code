function varargout = xpsControlGUI_group(varargin)
% XPSCONTROLGUI_GROUP MATLAB code for xpsControlGUI_group.fig
%      XPSCONTROLGUI_GROUP, by itself, creates a new XPSCONTROLGUI_GROUP or raises the existing
%      singleton*.
%
%      H = XPSCONTROLGUI_GROUP returns the handle to a new XPSCONTROLGUI_GROUP or the handle to
%      the existing singleton*.
%
%      XPSCONTROLGUI_GROUP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in XPSCONTROLGUI_GROUP.M with the given input arguments.
%
%      XPSCONTROLGUI_GROUP('Property','Value',...) creates a new XPSCONTROLGUI_GROUP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before xpsControlGUI_group_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to xpsControlGUI_group_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help xpsControlGUI_group

% Last Modified by GUIDE v2.5 23-Aug-2020 10:09:09

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @xpsControlGUI_group_OpeningFcn, ...
    'gui_OutputFcn',  @xpsControlGUI_group_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before xpsControlGUI_group is made visible.
function xpsControlGUI_group_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to xpsControlGUI_group (see VARARGIN)

% Choose default command line output for xpsControlGUI_group
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes xpsControlGUI_group wait for user response (see UIRESUME)
% uiwait(handles.figure1);
global coefficients_path probe_number
...
function varargout = xpsControlGUI_group_OutputFcn(hObject, eventdata, handles)
